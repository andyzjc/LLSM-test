function [Vol1,Vol2,GTallbeads] = beadsSimulation3d_focal(PSFexc,PSFdet,SNR)
...
%     overallPSF = ShiftedPSFexc.* PSFdet;
    ...
    overallPSF = PSFexc .* PSFdet;
    fftvol = fftshift(fftn(ifftshift(Vol))) .* fftshift(fftn(ifftshift(overallPSF)));
